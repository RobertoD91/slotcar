...
(function (global) {
  ...
  var DICT = {
    it: {
      ...
      "sys.esp32.urlHint": "Vuoto = la stessa origine della pagina, che è il caso normale quando è il ponte a servirla. Si scrive solo se il cronometro sta altrove (per esempio ws://ds200.local/ws).",
      "sys.ds.baud": "Baud",
    ...
    en: {
      ...
      "sys.esp32.urlHint": "Empty = same origin as the page, which is the normal case when the bridge serves it. Fill it in only if the lap timer lives elsewhere (e.g. ws://ds200.local/ws).",
      "sys.ds.baud": "Baud",
    ...
    es: {
      ...
      "sys.esp32.urlHint": "Vacío = el mismo origen de la página, que es lo normal cuando la sirve el puente. Rellénalo solo si el cronómetro está en otro sitio (p. ej. ws://ds200.local/ws).",
      "sys.ds.baud": "Baudios",
    ...
    fr: {
      ...
      "sys.esp32.urlHint": "Vide = la même origine que la page, ce qui est le cas normal quand c\'est le pont qui la sert. À remplir seulement si le chronomètre est ailleurs (ex. ws://ds200.local/ws).",
      "sys.ds.baud": "Bauds",
    ...
    de: {
      ...
      "sys.esp32.urlHint": "Leer = dieselbe Herkunft wie die Seite, der Normalfall wenn die Brücke sie ausliefert. Nur ausfüllen, wenn die Zeitmessung woanders läuft (z. B. ws://ds200.local/ws).",
      "sys.ds.baud": "Baud",
