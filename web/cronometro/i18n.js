...
(function (global) {
  ...
  var DICT = {
    it: {
      ...
      "sys.ds200": "DS200",
      "sys.ds200.desc": "Cronometro DS Electronic DS200 — 2 corsie, RS-232 a 4800 baud.",
      "sys.ds300": "DS300",
      "sys.ds300.desc": "Cronometro DS Electronic DS300 — fino a 8 corsie, RS-232 a 57600 baud.",
      "sys.esp32": "DS200/DS300 senza fili (ponte ESP32)",
      "sys.esp32.desc": "La stessa centralina, ma i frame arrivano da un ESP32 collegato alla seriale: niente cavo al computer. Si usa aprendo la pagina servita dal ponte.",
      "sys.esp32.url": "Indirizzo del ponte",
      "sys.esp32.urlHint": "Vuoto = la stessa origine della pagina, che è il caso normale quando è il ponte a servirla. Dal sito pubblicato (https) serve un indirizzo wss:// con un certificato valido — altrimenti il browser blocca il collegamento: in quel caso è più semplice il Bluetooth.",
      "sys.ble": "DS200/DS300 via Bluetooth (ponte ESP32)",
      "sys.ble.desc": "Lo stesso ponte, ma senza rete: la pagina parla al dispositivo direttamente. È l'unico modo che funziona dal sito pubblicato, perché non serve né wifi né certificato. ⚠️ Non su iPhone/iPad: Safari non ha il Bluetooth web.",
      "sys.ds.baud": "Baud",
      "sys.ds.baudHint": "Il baud lo porta la centralina che hai scelto: si cambia solo per provare.",
      "setup.advanced": "Avanzate",
      "setup.modeFromBox": "la decide la centralina",
      "prog.kind.laps": "{n} giri (individuali)",
      "prog.kind.lapsTotal": "{n} giri (totali)",
      "prog.kind.time": "a tempo",
      "prog.kind.f1": "modalità F1",
      "prog.other": "La centralina sta correndo: {prog}. Quella regola non la sappiamo arbitrare, quindi l'app registra e basta — giri, tempi e classifica —, e la bandiera la sventola lei.",
    ...
    en: {
      ...
      "sys.ds200": "DS200",
      "sys.ds200.desc": "DS Electronic DS200 timer — 2 lanes, RS-232 at 4800 baud.",
      "sys.ds300": "DS300",
      "sys.ds300.desc": "DS Electronic DS300 timer — up to 8 lanes, RS-232 at 57600 baud.",
      "sys.esp32": "DS200/DS300 wireless (ESP32 bridge)",
      "sys.esp32.desc": "The same timer box, but the frames arrive from an ESP32 wired to its serial port: no cable to the computer. Use it from the page the bridge serves.",
      "sys.esp32.url": "Bridge address",
      "sys.esp32.urlHint": "Empty = same origin as the page, which is the normal case when the bridge serves it. From the published site (https) you need a wss:// address with a valid certificate — otherwise the browser blocks it: Bluetooth is simpler in that case.",
      "sys.ble": "DS200/DS300 over Bluetooth (ESP32 bridge)",
      "sys.ble.desc": "The same bridge, without the network: the page talks straight to the device. It is the only way that works from the published site, because it needs neither wifi nor a certificate. ⚠️ Not on iPhone/iPad: Safari has no Web Bluetooth.",
      "sys.ds.baud": "Baud",
      "sys.ds.baudHint": "The baud comes with the box you picked: change it only for testing.",
      "setup.advanced": "Advanced",
      "setup.modeFromBox": "the timer box decides",
      "prog.kind.laps": "{n} laps (individual)",
      "prog.kind.lapsTotal": "{n} laps (total)",
      "prog.kind.time": "by time",
      "prog.kind.f1": "F1 mode",
      "prog.other": "The timer box is running: {prog}. We cannot arbitrate that rule, so the app just records — laps, times and standings — and the box waves the flag.",
    ...
    es: {
      ...
      "sys.ds200": "DS200",
      "sys.ds200.desc": "Cronómetro DS Electronic DS200 — 2 carriles, RS-232 a 4800 baudios.",
      "sys.ds300": "DS300",
      "sys.ds300.desc": "Cronómetro DS Electronic DS300 — hasta 8 carriles, RS-232 a 57600 baudios.",
      "sys.esp32": "DS200/DS300 sin cables (puente ESP32)",
      "sys.esp32.desc": "La misma central, pero las tramas llegan de un ESP32 conectado a su serie: sin cable al ordenador. Se usa desde la página que sirve el puente.",
      "sys.esp32.url": "Dirección del puente",
      "sys.esp32.urlHint": "Vacío = el mismo origen de la página, que es lo normal cuando la sirve el puente. Desde el sitio publicado (https) hace falta una dirección wss:// con certificado válido — si no, el navegador lo bloquea: en ese caso es más fácil el Bluetooth.",
      "sys.ble": "DS200/DS300 por Bluetooth (puente ESP32)",
      "sys.ble.desc": "El mismo puente, sin red: la página habla directamente con el dispositivo. Es la única forma que funciona desde el sitio publicado, porque no necesita ni wifi ni certificado. ⚠️ No en iPhone/iPad: Safari no tiene Web Bluetooth.",
      "sys.ds.baud": "Baudios",
      "sys.ds.baudHint": "Los baudios los trae la central elegida: cámbialos solo para probar.",
      "setup.advanced": "Avanzado",
      "setup.modeFromBox": "lo decide la central",
      "prog.kind.laps": "{n} vueltas (individuales)",
      "prog.kind.lapsTotal": "{n} vueltas (totales)",
      "prog.kind.time": "por tiempo",
      "prog.kind.f1": "modo F1",
      "prog.other": "La central está corriendo: {prog}. Esa regla no sabemos arbitrarla, así que la app solo registra — vueltas, tiempos y clasificación — y la bandera la saca ella.",
    ...
    fr: {
      ...
      "sys.ds200": "DS200",
      "sys.ds200.desc": "Chronomètre DS Electronic DS200 — 2 couloirs, RS-232 à 4800 bauds.",
      "sys.ds300": "DS300",
      "sys.ds300.desc": "Chronomètre DS Electronic DS300 — jusqu'à 8 couloirs, RS-232 à 57600 bauds.",
      "sys.esp32": "DS200/DS300 sans fil (pont ESP32)",
      "sys.esp32.desc": "La même centrale, mais les trames viennent d\'un ESP32 relié à sa liaison série : aucun câble vers l\'ordinateur. À utiliser depuis la page servie par le pont.",
      "sys.esp32.url": "Adresse du pont",
      "sys.esp32.urlHint": "Vide = la même origine que la page, ce qui est le cas normal quand c'est le pont qui la sert. Depuis le site publié (https) il faut une adresse wss:// avec un certificat valide — sinon le navigateur bloque : dans ce cas le Bluetooth est plus simple.",
      "sys.ble": "DS200/DS300 par Bluetooth (pont ESP32)",
      "sys.ble.desc": "Le même pont, sans réseau : la page parle directement à l’appareil. C’est la seule voie qui marche depuis le site publié, car elle ne demande ni wifi ni certificat. ⚠️ Pas sur iPhone/iPad : Safari n’a pas le Bluetooth web.",
      "sys.ds.baud": "Bauds",
      "sys.ds.baudHint": "Les bauds viennent avec la centrale choisie : à changer seulement pour tester.",
      "setup.advanced": "Avancé",
      "setup.modeFromBox": "c'est la centrale qui décide",
      "prog.kind.laps": "{n} tours (individuels)",
      "prog.kind.lapsTotal": "{n} tours (au total)",
      "prog.kind.time": "au temps",
      "prog.kind.f1": "mode F1",
      "prog.other": "La centrale fait courir : {prog}. Nous ne savons pas arbitrer cette règle, donc l'app se contente d'enregistrer — tours, temps et classement — et c'est elle qui agite le drapeau.",
    ...
    de: {
      ...
      "sys.ds200": "DS200",
      "sys.ds200.desc": "DS Electronic DS200 — 2 Spuren, RS-232 mit 4800 Baud.",
      "sys.ds300": "DS300",
      "sys.ds300.desc": "DS Electronic DS300 — bis zu 8 Spuren, RS-232 mit 57600 Baud.",
      "sys.esp32": "DS200/DS300 kabellos (ESP32-Brücke)",
      "sys.esp32.desc": "Dieselbe Zentrale, aber die Frames kommen von einem ESP32 an ihrer seriellen Schnittstelle: kein Kabel zum Rechner. Über die von der Brücke ausgelieferte Seite verwenden.",
      "sys.esp32.url": "Adresse der Brücke",
      "sys.esp32.urlHint": "Leer = dieselbe Herkunft wie die Seite, der Normalfall wenn die Brücke sie ausliefert. Von der veröffentlichten Seite (https) braucht es eine wss://-Adresse mit gültigem Zertifikat — sonst blockiert der Browser: dann ist Bluetooth einfacher.",
      "sys.ble": "DS200/DS300 über Bluetooth (ESP32-Brücke)",
      "sys.ble.desc": "Dieselbe Brücke, ohne Netzwerk: die Seite spricht direkt mit dem Gerät. Der einzige Weg, der von der veröffentlichten Seite aus funktioniert, denn er braucht weder WLAN noch Zertifikat. ⚠️ Nicht auf iPhone/iPad: Safari hat kein Web Bluetooth.",
      "sys.ds.baud": "Baud",
      "sys.ds.baudHint": "Die Baudrate kommt mit der gewählten Zentrale: nur zum Testen ändern.",
      "setup.advanced": "Erweitert",
      "setup.modeFromBox": "entscheidet die Zentrale",
      "prog.kind.laps": "{n} Runden (einzeln)",
      "prog.kind.lapsTotal": "{n} Runden (gesamt)",
      "prog.kind.time": "nach Zeit",
      "prog.kind.f1": "F1-Modus",
      "prog.other": "Die Zentrale fährt: {prog}. Diese Regel können wir nicht anwenden, also zeichnet die App nur auf — Runden, Zeiten und Wertung — und die Zentrale schwenkt die Flagge.",
