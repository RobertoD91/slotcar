...
(function (global) {
  ...
  var DICT = {
    it: {
      ...
      "setup.mode": "Modalità",
      "setup.laps": "Giri",
      "setup.lapsFromBox": "lo dice la centralina",
    ...
    en: {
      ...
      "setup.mode": "Mode",
      "setup.laps": "Laps",
      "setup.lapsFromBox": "set on the timer box",
    ...
    es: {
      ...
      "setup.mode": "Modo",
      "setup.laps": "Vueltas",
      "setup.lapsFromBox": "lo indica la central",
    ...
    fr: {
      ...
      "setup.mode": "Mode",
      "setup.laps": "Tours",
      "setup.lapsFromBox": "c'est la centrale qui le dit",
    ...
    de: {
      ...
      "setup.mode": "Modus",
      "setup.laps": "Runden",
      "setup.lapsFromBox": "sagt die Zentrale",
